export const LYRICS = {
  ...
  2: {
    ...
    lyrics: [
      ["//Por que Dele e por Ele", "Para Ele são todas as coisas// (2x)"],
      ["A Ele a glória... (3x)", "Pra sempre, amém"],
      [
      ...
      ["A Ele a glória (3x)"],
      ["", "------------------", "A Él sea la gloria", "------------------"],
      ["//Todo es de mi Cristo", "Por Él y para Él//  (2x)"],
      ["A Él sea la gloria...  (3x)", "Por siempre amén"],
      [
      ...
      ["", "-------------------", "For him to be glory", "-------------------"],
      ["//For of him and through him", "And to him are all things//  (2x)"],
      ["To him be glory... (3x)", "Forever, amen"],
      [
  ...
  10: {
    ...
    lyrics: [
      ...
      ["Creo en ti Jesús", "Y lo que harás en mí", "En mí, en mí"],
      [
  ...
  15: {
    ...
    lyrics: [
      ...
      ["And when I am alone  (3x)", "Give me Jesus"],
      ["Give me Jesus..."],
      ["And when I come to die  (3x)", "Give me Jesus"],
      ["Give me Jesus..."],
    ],
  },
  16: {
  ...
  24: {
    ...
    lyrics: [
      ["//I woke up this mornin' with my mind", "Stayed on Jesus// (3x)"],
      ["Hallelu (Hallelu)", "Hallelu (Hallelu)", "Hallelu Hallelujah"],
      ["//I'm walkin' and talkin' with my mind", "Stayed on Jesus// (3x)"],
      ["Hallelu (Hallelu)..."],
      ["//I'm singin' and praisin' with my mind", "Stayed on Jesus// (3x)"],
      ["Hallelu (Hallelu)..."],
      ["Oh there ain't no harm to keep your mind", "Stayed on Jesus (3x)"],
      ["Hallelu (Hallelu)..."],
      [
        "",
        "----------------------",
      ...
      ["Estoy caminando y hablando con mi mente", "Puesta en jesucristo (3x)"],
      ["Alelu (alelu)..."],
      ["Estoy cantando y alabando con mi mente", "Puesta en jesucristo (3x)"],
      ["Alelu (alelu)..."],
      ["No hay nada malo en mantener la mente", "Puesta en jesucristo (3x)"],
      ["Alelu (alelu)..."],
    ],
  },
  25: {
  ...
  36: {
    ...
    lyrics: [
      ...
      ["This is my daily bread (2x)", "Your very word spoken to me"],
      ...
      ["Este é o meu respirar (2x)", "Teu Santo Espírito vivendo em mim"],
      ["E este é o meu pão (2x)", "Tua vontade feita em mim"],
      ["E eu, eu nada sou sem Ti", "E eu, perdido estou sem Ti"],
      ["", "-------------------", "Tu eres mi respirar", "-------------------"],
      ["Tu eres mi respirar (2x)", "Dios tu presencia vive en mi"],
      ["Tu eres mi pan Señor (2x)", "Dios tus palabras son para mi"],
